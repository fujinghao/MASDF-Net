...
if __name__ == '__main__':
    path = r'C:\Users\A\PycharmProjects\seg\TransFuse-main\data/'
    ...
    for i in range(50):
        ...
        plt.imshow(img)
        plt.savefig(r'C:\Users\A\PycharmProjects\seg\TransFuse-main\vis/'+str(i)+".jpg")
 
        plt.imshow(gt[0])
        plt.savefig(r'C:\Users\A\PycharmProjects\seg\TransFuse-main\vis/'+str(i)+'_gt.jpg')
